...
var alertMsg = document.querySelector('#noty_layout__topRight');
...
if (adminAreaPath.includes('admin')) {
  ...
  var cartremove = document.querySelector('.cartremove');

  if (cartremove) {
    cartremove.classList.add('hidden');
  }
}
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
    var stripe, card, paymentCOD, paymentCARD, paymentForm;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_2__.loadStripe)('pk_test_51IHSvuKIfkbrsvhDLphlOfIClH8FbJelGK0zYvMxmTyrHr4bAdT5XteRD8mO2lsFruzMQA7raV5frtDNOF8VAykE00VcXl8rk2');

          case 2:
            stripe = _context2.sent;
            card = null;
            paymentCOD = document.querySelector('#paymentCOD');
          ...
          case 8:
            paymentCOD.addEventListener('change', function (cod) {
              card = new _CardWidget__WEBPACK_IMPORTED_MODULE_3__.CardWidget(stripe);
              card.destroy();
            });
            paymentCARD.addEventListener('change', function (card) {
              card = new _CardWidget__WEBPACK_IMPORTED_MODULE_3__.CardWidget(stripe);
              card.mount();
